  ...
  <q-layout view="lHh Lpr lFf">
    <q-header elevated>
      <q-toolbar>
        ...
        <q-toolbar-title>Relationships</q-toolbar-title>
        <q-space />
    ...
    <q-page-container>
      <q-page class="q-pa-md">
        <div class="text-h4 q-mb-md">Relationships</div>
        <div class="text-body1">Relationships management coming soon...</div>
      </q-page>
    </q-page-container>
  </q-layout>
</template>
